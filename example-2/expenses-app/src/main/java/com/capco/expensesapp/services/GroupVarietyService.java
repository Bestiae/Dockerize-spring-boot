...
public class GroupVarietyService {
    ...
    public GroupVarietyDTO findGroupVarietyByName(String groupName) {
        log.info("Find group by name -> groupVarietyRepository.findGroupVarietyByGroupVarietyName({});", groupName);
        return  modelMapper.map(groupVarietyRepository.findGroupVarietyByGroupVarietyName(groupName),
