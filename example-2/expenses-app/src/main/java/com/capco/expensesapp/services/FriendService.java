...
public class FriendService {
    ...
    public void addFriend(Long friendOne, Long friendTwo){
        log.info("friendRepository.addFriend({},{});", friendOne, friendTwo);
        ...
        friendRepository.addFriend(friendOne, friendTwo);
    }
